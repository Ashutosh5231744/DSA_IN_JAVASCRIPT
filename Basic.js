...
// write a function to search an element  in an Array and than return the index
...
//  let ans=searching([11,42,423,6543,7],7);
//  console.log(ans);

 // Write an Function that return negative number in an array
...
//   let ans=countNegativeNumber([-9,-3,-4,-2,-5,-9])
//   console.log(ans);
...
//     return largest
// }
// let ans =largestElement([1,2,3,5,9])
// console.log(ans);


// write an function to return tha second alrgest element in an array
...
// }
//    let ans=secondlargest([1,2,3,4,5,9])
//    console.log(ans);
...
function countDigits(num){
    let count=0;
    num=Math.abs(num)// it handels  the negative numbes
    while(num>0){
        num=Math.floor(num/10);  // it handles the decimals numbers 
        count++;
    }
        return count;
}
let ans =countDigits(-987)
console.log(ans);
